...
**Why defensible:** Pattern holds per-decade (1960–79: r = 0.9778; 1980–99: r = 0.9101; 2000–16: r = 0.9544), survives alternative metrics (weighted points produce identical top-8), and removing team events entirely collapses inflation to mean 0.9710 — confirming team-row multiplication as sole cause.
